...
public class Exercise31_20 extends Application {
	@Override // Override the start method in the Application class
	  public void start(Stage primaryStage) {   
	    ...
	    top.setToggleGroup(toggle);
	    RadioButton bottom = new RadioButton("Bottom");
	    bottom.setToggleGroup(toggle);
	    RadioButton right = new RadioButton("Right");
	    right.setToggleGroup(toggle);
	    RadioButton left = new RadioButton("Left");
	    left.setToggleGroup(toggle);

	    HBox setting = new HBox(10, top, bottom, right, left);
	    setting.setAlignment(Pos.CENTER);
	    VBox pane = new VBox(10, tabPane, setting);
